...
```bash
clj-nrepl-eval -p 7888 "(require '[ascolais.phandaal :as phandaal] :reload)"
```

Then call functions from it:

```bash
clj-nrepl-eval -p 7888 "(phandaal/some-function arg1 arg2)"
```
...
```bash
clj-nrepl-eval -p 7888 "(require '[ascolais.phandaal] :reload)"
```
...
clj-nrepl-eval -p 7888 "(require '[ascolais.phandaal-test] :reload)"
clj-nrepl-eval -p 7888 "(run-tests 'ascolais.phandaal-test)"
```
